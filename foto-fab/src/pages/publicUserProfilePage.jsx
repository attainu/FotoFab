...
class PublicUserProfilePage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchPublicUserLikedPhotos(username);
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.match.params.username !== this.props.match.params.username) {
      ...
      this.props.fetchPublicUserPhotos(this.props.match.params.username);
      this.props.fetchPublicUserLikedPhotos(this.props.match.params.username);
